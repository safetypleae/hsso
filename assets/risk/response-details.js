...
export function confirmSurveyDeletion(survey,{deleted,loginRequired}){
  const dialog=el('dialog','','risk-qr-dialog'),title=el('h2','설문 삭제 확인'),description=el('p',`“${survey.title}” 설문과 응답 ${survey.responseCount}건, 문항 이력이 함께 삭제됩니다. 기존 링크와 QR도 사용할 수 없습니다. 되돌릴 수 없습니다.`);
